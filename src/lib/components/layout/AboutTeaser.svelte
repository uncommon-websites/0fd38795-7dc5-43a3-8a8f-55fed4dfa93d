...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Devin Bhushan",
		role: "CEO & Founder",
		image: '/generated/image-a-portrait-of-a-south-asian-male-founder.webp'
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I started Squint because my nephew said, 'Uncle Devin, just show me the video.' So we built the system everyone now wishes they had."`}
